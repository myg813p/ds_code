...
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### 
                ...
                for time6 in range(6):
                    ...
                    replace_words = ['무료배송', '의자BEST', '땡처리특가', '가격인하특가', 'MD추천', '무료배송 특가', '/낱개선택', '/무료배송','제주도배송','동서특가', '설연휴특가', '원데이특가', '원데이행사', '브랜드위크', '동서가구 단독/쿠폰다운', '주말특가', '주말 특가', '위클리딜', '식탁생활', '최저가 도전', '1% 추가할인', '사은품증정', '소파마켓', '[단독쿠폰(~4/30까지)]', 'BEST인기식탁', '[', '지정배송서비스']
